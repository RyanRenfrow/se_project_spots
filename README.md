...
I used flex to align the lements accordingly as that's what worked best for me as oppose to grid. Example of flex being used to have the new post button horizontal to the profile picture, to match figma. 
I also used rgb color method instead of hex and hasthtag as the rgb method mirrored figmas. Also to make it more uniform/consistent in VSCODE.
